...
public class ClassFinder {
	...
	@SuppressWarnings("rawtypes")
	public static List<Class> findClasses(Collection<String> packageNameColl,
			Collection<String> suffixColl) {
		logger.trace("find classes from:" + packageNameColl + " suffixes:"
				+ suffixColl);
	...
	private static List<String> filter(List<String> classNameList,
			Collection<String> packageNameColl, Collection<String> suffixColl) {
	...
	private static boolean isFit(String className,
			Collection<String> packageNameColl, Collection<String> suffixColl) {
	...
	private static void scanDir(File dir, List<String> classNames,
			String packageName) {
